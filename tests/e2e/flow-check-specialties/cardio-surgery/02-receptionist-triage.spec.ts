...
test.describe('Step 2: Receptionist Check-In & Nurse Triage - Cardio Surgery', () => {
  ...
  test('TC_TRIAGE_CARDIO_SURGERY [VALID]: Receptionist Check-In & Triage for Cardio Surgery', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Username or Email' }).fill('qa.cardiosurgery@omnivva.com');
    ...
    await complaintInput.fill('Routine Cardio Surgery checkup and nurse triage evaluation');
