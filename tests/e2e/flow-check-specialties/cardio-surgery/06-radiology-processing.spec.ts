...
test.describe('Step 6: Radiology Scan Processing & Reporting - Cardio Surgery', () => {

  test('TC_RAD_CARDIO_SURGERY [VALID]: Radiology Scan Processing for Cardio Surgery', async ({ page }) => {
