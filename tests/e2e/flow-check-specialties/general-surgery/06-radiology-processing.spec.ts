...
test.describe('Step 6: Radiology Scan Processing & Reporting - General Surgery', () => {

  test('TC_RAD_GENERAL_SURGERY [VALID]: Radiology Scan Processing for General Surgery', async ({ page }) => {
