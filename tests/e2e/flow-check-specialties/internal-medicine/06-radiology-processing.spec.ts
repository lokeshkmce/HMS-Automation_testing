...
test.describe('Step 6: Radiology Scan Processing & Reporting - Internal Medicine', () => {

  test('TC_RAD_INTERNAL_MEDICINE [VALID]: Radiology Scan Processing for Internal Medicine', async ({ page }) => {
