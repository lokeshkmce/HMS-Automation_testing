...
test.describe('Step 3: Doctor Consultation & Prescription - ENT', () => {
  ...
  test('TC_DOC_ENT [VALID]: Doctor Consultation for ENT', async ({ page }) => {
    ...
    // 1. Staff Login
    await loginPage.loginAsStaff('qa.ent@omnivva.com', 'password123');
    ...
    await doctorPage.completeFull3StepConsultation('ENT', {
      specialty: 'ENT',
      chiefComplaint: 'Clinical consultation and examination required for ENT',
      referredBy: 'Dr. QA Hospital / Self',
      imagingFindings: 'Normal clinical/imaging findings for ENT. No acute abnormalities.',
      provisionalDiagnosis: 'Provisional Diagnosis - ENT',
      icd10Code: 'H66.90',
      treatmentPlan: 'Standard medical treatment and supportive care for ENT. Return for review in 7 days.',
