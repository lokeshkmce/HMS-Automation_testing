...
test.describe('Step 2: Receptionist Check-In & Nurse Triage - Emergency & Endocrinology', () => {
  ...
  test('TC_TRIAGE_EMERGENCY_ENDOCRINOLOGY [VALID]: Receptionist Check-In & Triage for Emergency & Endocrinology', async ({ page }) => {
    ...
    await expect(docOption, `QA Doctor "Dr. QA emergency.endo" must be visible in dropdown`).toBeVisible({ timeout: 15_000 });
    ...
    await complaintInput.fill('Routine Emergency & Endocrinology checkup and nurse triage evaluation');
