...
test.describe('Step 6: Radiology Scan Processing & Reporting - Emergency & Endocrinology', () => {

  test('TC_RAD_EMERGENCY_ENDOCRINOLOGY [VALID]: Radiology Scan Processing for Emergency & Endocrinology', async ({ page }) => {
