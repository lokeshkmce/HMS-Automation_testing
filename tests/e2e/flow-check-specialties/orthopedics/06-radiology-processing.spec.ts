...
test.describe('Step 6: Radiology Scan Processing & Reporting - Orthopedics', () => {

  test('TC_RAD_ORTHOPEDICS [VALID]: Radiology Scan Processing for Orthopedics', async ({ page }) => {
