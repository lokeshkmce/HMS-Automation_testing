...
test.describe('Step 6: Radiology Scan Processing & Reporting - Gastroenterology', () => {

  test('TC_RAD_GASTROENTEROLOGY [VALID]: Radiology Scan Processing for Gastroenterology', async ({ page }) => {
