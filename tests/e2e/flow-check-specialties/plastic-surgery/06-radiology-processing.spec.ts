...
test.describe('Step 6: Radiology Scan Processing & Reporting - Plastic Surgery', () => {

  test('TC_RAD_PLASTIC_SURGERY [VALID]: Radiology Scan Processing for Plastic Surgery', async ({ page }) => {
