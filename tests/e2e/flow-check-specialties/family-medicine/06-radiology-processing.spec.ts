...
test.describe('Step 6: Radiology Scan Processing & Reporting - Family Medicine', () => {

  test('TC_RAD_FAMILY_MEDICINE [VALID]: Radiology Scan Processing for Family Medicine', async ({ page }) => {
