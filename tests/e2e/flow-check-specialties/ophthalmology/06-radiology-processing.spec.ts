...
test.describe('Step 6: Radiology Scan Processing & Reporting - Ophthalmology', () => {

  test('TC_RAD_OPHTHALMOLOGY [VALID]: Radiology Scan Processing for Ophthalmology', async ({ page }) => {
