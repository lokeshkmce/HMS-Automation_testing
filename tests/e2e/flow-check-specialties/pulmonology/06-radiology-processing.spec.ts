...
test.describe('Step 6: Radiology Scan Processing & Reporting - Pulmonology', () => {

  test('TC_RAD_PULMONOLOGY [VALID]: Radiology Scan Processing for Pulmonology', async ({ page }) => {
