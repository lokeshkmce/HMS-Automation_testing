...
test.describe('Step 6: Radiology Scan Processing & Reporting - Infectious Disease', () => {

  test('TC_RAD_INFECTIOUS_DISEASE [VALID]: Radiology Scan Processing for Infectious Disease', async ({ page }) => {
