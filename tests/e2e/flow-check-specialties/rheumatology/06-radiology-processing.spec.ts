...
test.describe('Step 6: Radiology Scan Processing & Reporting - Rheumatology', () => {

  test('TC_RAD_RHEUMATOLOGY [VALID]: Radiology Scan Processing for Rheumatology', async ({ page }) => {
