...
test.describe('Step 6: Radiology Scan Processing & Reporting - Neurosurgery', () => {

  test('TC_RAD_NEUROSURGERY [VALID]: Radiology Scan Processing for Neurosurgery', async ({ page }) => {
